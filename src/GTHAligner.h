...
public:
	...
	virtual ~GTHAligner();
	bool is_available();
	void do_spliced_alignment(const string& genomic_file, const string& type, const string& probe_file, const string& species, const Params& params, const string& output_file);
