...
public:
	...
	int parse_output(const string& output_file, unordered_set<string>& mapped_reads, const int lib_idx, const int read_part, const string& left_read_index, const string& right_read_index, const string& out_left_read, const string& out_right_read);
