...
public:
	...
	virtual void do_spliced_alignment(const string& genomic_file, const string& type, const string& probe_file, const string& species, const Params& params, const string& output_file)=0;
	...
	virtual int get_longest_match(int round, int k, const double& min_score, const unsigned int& ini_contig_size, const string& alignment_file, tuple_map& best_hits)=0;
